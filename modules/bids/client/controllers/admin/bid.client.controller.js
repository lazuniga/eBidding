(function () {
  ...
  angular
    .module('bids.admin')
    .controller('BidsAdminController', BidsAdminController);

  BidsAdminController.$inject = ['$scope', '$state', '$window', 'bidResolve', 'Authentication', 'Notification', 'AdminService', '$timeout', 'Upload'];

  function BidsAdminController($scope, $state, $window, bid, Authentication, Notification, AdminService, $timeout, Upload) {
    var vm = this;
    ...
    function save(isValid) {
      ...
      function successCallback(res) {
        $state.go('admin.bids.list'); // should we send the User to the list or the updated Bid's view?
