(function () {
  ...
  describe('Articles Admin Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      var sampleArticleBidData;

      beforeEach(function () {
        // Create a sample article object
        sampleArticleBidData = new ArticlesService({
          title: 'An Article about MEAN',
          content: 'MEAN rocks!'
        });

        $scope.vm.article = sampleArticleBidData;
      });
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (ArticlesService) {
        // Set POST response
        $httpBackend.expectPOST('/api/articles', sampleArticleBidData).respond(mockArticle);
      ...
      it('should call Notification.error if error', function () {
        ...
        $httpBackend.expectPOST('/api/articles', sampleArticleBidData).respond(400, {
